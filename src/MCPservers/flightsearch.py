...
#fetch one specific flight details using its ID (one flight)
...
#fetch flights from API from the given origin, destination and date (many flights)
...
@mcp.tool(description="Get details of a specific flight by its ID")
...
@mcp.tool(description="Search for available flights between two airports on a specific date")
